<?php
// Path: /network-management/views/admin/addDevice.php
...
// Xử lý yêu cầu thêm thiết bị qua POST
    ...
    try {
        ...
        $params = [
            'data' => [
                ...
                'last_maintenance' => $_POST['maintenance_date'] ?? '',
                'price' => $_POST['price'] ?? 0,
                'image' => $imagePath ?? '../../assets/images/devices/laptop-solid.svg'
            ]
        ];

        $result = $deviceController->handleRequest('add', $params);
        ...
        error_log("Lỗi trong addDevice.php: " . $e->getMessage());
        echo json_encode([
            'status' => 'error',
...
<body>
    ...
    <div class="main-wrapper">
        ...
        if (file_exists(__DIR__ . '/../../includes/header.php')) {
            ...
            echo '<div class="alert alert-danger">Lỗi: Không tìm thấy header.php</div>';
        }
        if (file_exists(__DIR__ . '/../../includes/sidebarAll.php')) {
            include __DIR__ . '/../../includes/sidebarAll.php'; 
        } else {
            echo '<div class="alert alert-danger">Lỗi: Không tìm thấy sidebar.php</div>';
        }
        ?>
            ...
            <div class="content">
                <div class="page-header">
                    <div class="page-title">
                        ...
                        <h6>Tạo một thiết bị mới trong hệ thống</h6>
                    </div>
                </div>
                ...
                <div class="card">
                    <div class="card-body">
                        <form id="addDeviceForm" enctype="multipart/form-data" method="POST">
                            <div class="row">
                                ...
                                <div class="col-lg-12">
                                    <button type="submit" class="btn btn-primary me-2">Thêm thiết bị</button>
