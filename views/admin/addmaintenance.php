...
$_SESSION['user_id'] = 2; // Giả lập user_id giống đoạn code test
$_SESSION['role'] = 'admin'; // Giả lập role giống đoạn code test
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    try {
        ...
        // Gọi handleRequest
        $response = $controller->handleRequest('add_maintenance', ['data' => $maintenanceData]);
            ...
            <div class="content">
                <div class="page-header">
                    <div class="page-title">
                        ...
                        <h6>Trang thêm bảo trì thiết bị dành cho Admin</h6>
                    </div>
                </div>
                ...
                success: function(response) {
                    ...
                    if (response.status === 'success') {
                        ...
                        setTimeout(() => window.location.href =
                            '/network-management/views/admin/maintenancelist.php', 1000);
                    } else {
