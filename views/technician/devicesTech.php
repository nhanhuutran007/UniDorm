...
$techDeviceController = new DeviceController($_SESSION['user_id'], $_SESSION['role']);
$result = $techDeviceController->handleRequest('get', [
...
if (isset($result['success']) && $result['success']) {
    $devices = $result['data'] ?? [];
    // Lấy log gần nhất cho từng thiết bị
    foreach ($devices as &$device) {
        $logResult = $techDeviceController->handleRequest('get_log', [
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="table-responsive ">
                            <table class="table datanew" id="staffDevicesTable">
                                <thead>
                                    <tr>
                                        <th>ID</th>
                                        <th>Hình ảnh</th>
                                ...
                                <tbody>
                                    ...
                                    <tr onclick="showDeviceModal(
                                        ...
                                        <!-- <td>
                                            <a class="me-3" href="../DeviceLog.php?device_id=<?= $device['device_id'] ?>">
                                                <img src="../../assets/img/icons/log.svg" alt="view log" width="29" height="29">
                                            </a>
                                        </td> -->
                                    </tr>
                                    <?php endforeach; ?>
