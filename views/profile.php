...
if (!$userData) {
    session_destroy();
    header("Location: /QuanLySV/auth/login.php?error=user_not_found");
    exit();
}
...
<head>
    ...
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.5.1/css/all.min.css"
        ...
        crossorigin="anonymous" referrerpolicy="no-referrer" />
    <!-- Custom CSS -->
    <link rel="stylesheet" href="/QuanLySV/assets/css/style.css">
</head>
...
<body>
                ...
                <div class="card">
                    <div class="card-body">
                            ...
                            <div class="profile-top">
                                <div class="profile-content">
                                    <div class="profile-contentimg">
                                        <img src="/QuanLySV/assets/<?php echo htmlspecialchars($userData['profile_picture'] ?? 'images/default.jpg'); ?>"
                                            alt="Profile Picture" id="blah">
                                        <div class="profileupload">
                                            <input type="file" id="imgInp" name="profile_picture" form="profileForm">
                                            <a href="javascript:void(0);">
                                                <img src="/QuanLySV/assets/img/icons/edit-set.svg" alt="edit">
                                            </a>
                                        </div>
                                    </div>
                                    <div class="profile-contentname">
                                        <h2><?php echo htmlspecialchars($userData['fullname'] ?? 'User'); ?></h2>
                                        <h4><?php echo htmlspecialchars($userData['role'] ?? 'Unknown Role'); ?> -
                                            Cập
                        ...
                        <form id="profileForm" method="POST" enctype="multipart/form-data"
                            action="/QuanLySV/controllers/ProfileController.php">
                            <div class="row">
    ...
    <script src="/QuanLySV/assets/js/script.js"></script>
    <script>
